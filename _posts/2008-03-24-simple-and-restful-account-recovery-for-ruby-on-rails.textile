...
The next step is to migrate your database to include email address for your users.  Just build your migration as below and run rake db:migrate.
...
ActionMailer methods include the basic properties of any email (sender, recipient, subject and body), however also let you pass variables into body text.  Build yours as below.
