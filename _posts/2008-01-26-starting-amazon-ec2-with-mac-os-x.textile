...
blurb: Go through the entire processes of creating your first EC2 server, using SSH to login to it, having it serve a webpage and then terminating it when finished.
category: Systems
---
...
RESERVATION     r-xxxxxxxx      xxxxxxxxxxxx    default
INSTANCE        i-xxxxxxxx      ami-23b6534a    ec2-xx-xxx-xx-xx.compute-1.amazonaws.com
{% endhighlight %}
