...
Get the Mac GPG installer for your version of Mac OS X from Sourceforge at "http://macgpg.sourceforge.net":http://macgpg.sourceforge.net.
...
gpg: key A7327C0E: "First and Last Name (Mac GPG Tutorial) <name@domain.com>" public key imported
