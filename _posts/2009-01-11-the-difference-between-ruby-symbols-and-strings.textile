...
*NOTE: Your object id's will be different than the ones above.*
...
So, back to benchmarking.  How much faster is comparing Symbols than to Strings?  Lets find out:
